...
replace (
	...
	github.com/openshift/hive/apis => github.com/openshift/hive/apis 77a42df42190
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/hashicorp/terraform-provider-aws 1fdc8befeb6f
