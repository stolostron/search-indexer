...
replace (
	...
	github.com/openshift/hive/apis => github.com/openshift/hive/apis ee292bfcbaa7
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/hashicorp/terraform-provider-aws f7a3b98da589
	...
	sigs.k8s.io/cluster-api-provider-azure => sigs.k8s.io/cluster-api-provider-azure v1.20.0
