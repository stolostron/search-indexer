...
replace (
	...
	github.com/openshift/hive/apis => github.com/openshift/hive/apis d03ed3f1340f
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/hashicorp/terraform-provider-aws e6b4d376df55
	...
	sigs.k8s.io/cluster-api-provider-azure => sigs.k8s.io/cluster-api-provider-azure v1.19.2
