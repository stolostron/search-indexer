...
replace (
	...
	github.com/openshift/hive/apis => github.com/openshift/hive/apis 44c3beacca13
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/hashicorp/terraform-provider-aws c68a2b96dee1
