...
replace (
	...
	github.com/openshift/hive/apis => github.com/openshift/hive/apis c7057c250eb7
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/hashicorp/terraform-provider-aws a0a8d695d268
