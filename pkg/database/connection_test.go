...
func Test_initializeTables(t *testing.T) {
	...
	mockPool.EXPECT().Exec(gomock.Any(), gomock.Eq("CREATE TABLE IF NOT EXISTS search.resources (uid TEXT PRIMARY KEY, cluster TEXT, data JSONB, kind_plural TEXT)")).Return(nil, nil)
