...
func Test_initializeTables(t *testing.T) {
	...
	mockPool.EXPECT().Exec(gomock.Any(), gomock.Eq("CREATE TABLE IF NOT EXISTS edges (sourceId TEXT PRIMARY KEY, sourceKind TEXT,destId TEXT,destKind TEXT,edgeType TEXT,cluster TEXT)")).Return(nil, nil)
